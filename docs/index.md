...
- `docs/product/job-types.md`
- `docs/product/workflow.md`
- `docs/product/data-handling.md`
- `docs/product/quality-bar.md`
- `docs/product/glossary.md`

### Spec

- `docs/spec/repo-structure.md`
- `docs/spec/job-readme-format.md`
- `docs/spec/community-api-query.md`
- `docs/spec/artifact-lifecycle.md`
- `docs/spec/templates.md`
- `docs/spec/checklists.md`

## Quick start: adding a new artifact

1. Create a new job folder at repo root using `docs/spec/repo-structure.md`.
2. Add a `README.md` following `docs/spec/job-readme-format.md`.
